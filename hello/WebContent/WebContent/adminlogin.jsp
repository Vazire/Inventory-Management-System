...
<body>
	...
	<div class="card">
  		...
  		<form action="dbadlog.jsp" method="post">
  		<input  class="form" type="text" required placeholder=" Admin ID*" name="adid"><br>
  		<input class="form" type="password" required placeholder="Admin Password *" name="adpass"><br>
