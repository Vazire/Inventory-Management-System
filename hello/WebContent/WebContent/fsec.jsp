...
<div class="card" style=" margin-top: 55px;max-width: 590px;padding:7px;">
...
<form id='register-form' action="dbfsec.jsp" method='post'>

<header style="margin-bottom:20px;margin-top:20px;">
<h4>Answer the following security questions</h4>
</header>

<input type="text" name="id" placeholder="Employee ID"  class="form" required style="width: 400px;"><br>
<input type="text" name="q1" placeholder="What is the name of your bestfriend?"  class="form" required style="width: 400px;"><br>
<input type="text" name="q2" placeholder="What is your favourite holiday destination?"  class="form" required style="width: 400px;"><br>
  
 



  <button type='submit' class="butn" style="margin-bottom: 30px;">Next</button>
