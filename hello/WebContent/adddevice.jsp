...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-white">
		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<a class="nav-link" href="https://www.techmahindra.com/Company/Testimonials/testimonial.aspx">Contact Us</a>
			</li>
		</ul>	
	</nav>
	<div class="card">
		<form action="dbadd.jsp" method="post">
			...
			<input  class="form" type="text" required placeholder=" Device ID*" name="did">
			<label>Device Name:</label>
			<input  class="form" type="text" required placeholder=" Device Name*" name="dname">
			<label>Model No:</label>
			<input class="form" type="text" required placeholder="Model No.*" name="modelno">
			<label>Location:</label>
			<input class="form" type="text" required placeholder="Location*" name="location">
			<input class="butn" type="submit" value="Add Device"><br>
</form>
</div>
</body>
</html>