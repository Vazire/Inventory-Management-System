...
<form id='register-form' action="dbsecurity.jsp" method='post'>
...
<h4>Answer the following security questions</h4>
  ...
  <input type="text" name="q1" placeholder="What is the name of your bestfriend?" required class="form" style="width: 400px;">

  <input type="text" name="q2" placeholder="What is your favourite holiday destination?" required class="form" style="width: 400px;">
  
 



  <button type='submit' class="butn" style="margin-bottom: 30px;">Register</button>
